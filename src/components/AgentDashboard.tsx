...
const applyFilters = async () => {
  ...
  // ================================================================
  // DIEGO & ANNA WORKSPACE REMAPPING (BEFORE ANY WORKSPACE FILTERING)
  // ================================================================
  // Business rule: Diego and Anna's reviews should appear in regular
  // workspaces (SkyPrivate/CMD), NOT in 360 workspaces, even if the
  // conversation has 360-related tags. Only Nicholas's reviews go to 360.
  //
  // This remapping runs BEFORE the workspace filter so that when users
  // select "SkyPrivate", Diego/Anna's 360 conversations (after remapping)
  // will match and appear.
  // ================================================================
  ...
  // Remap Diego/Anna's 360 conversations to regular workspaces
  // This happens for ALL conversations, regardless of selected filters
  ...
  console.log(`Diego/Anna workspace remap applied globally`);
  ...
  if (selectedWorkspaces.length > 0) {
    ...
    // Nicholas-only restriction for 360 workspaces:
    // When user selects a 360 workspace, only show Nicholas's reviews.
    // Diego/Anna's conversations were already remapped above, so they won't
    // match 360 workspace selections and are naturally excluded here.
